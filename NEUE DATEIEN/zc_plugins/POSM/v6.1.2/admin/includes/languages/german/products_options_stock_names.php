...
*/
define ('HEADING_TITLE', "Attribute Lagerbestand Manager: Out-of-Stock Labels verwalten");
define ('TEXT_INSTRUCTIONS', 'Verwenden Sie diese Seite, um Text Labels anzulegen und zu verwalten, die Sie für Artikel verwenden wollen, deren Lagerbestand vom <em>Attribute Lagerbestand Manager</em>verwaltet wird. Das Label, das Sie einem Artikel zuweisen wird dem Kunden angezeigt, wenn eine Variante &quot;out-of-stock&quot; ist. Sie können ein spezielles Symbol <b>[Datum]</b> verwenden, um (optional) festzulegen wo ein zugehöriges Datum eingefügt werden soll.');
