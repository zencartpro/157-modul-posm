...
* @version $Id: products_options_stock.php 2026-06-30 11:25:29Z webchills $
*/
...
define ('TEXT_POS_INSTRUCTIONS', 'Wählen Sie den Artikel, dessen Lagerbestand Sie verwalten wollen aus dem Dropdown Menü aus.  Falls hinter einem Artikelnamen ein "' . TEXT_POS_IDENTIFIER . '" steht, hat dieser Artikel derzeit bereits verwaltete Optionen. Wenn ein Artikel Options Kombinationen mit Lagerbeständen kleiner oder gleich dem eingestellen Mindestlagerbestand "' . POSM_STOCK_REORDER_LEVEL . '" hat oder ein Out-of-Stock Datum bald abläuft, wird der Artikelname im Dropdown <span class=\"out-of-stock\">rot hervorgehoben</span> dargestellt.<br /><br /><strong>Hinweis:</strong> Artikel Attribute werden (links nach rechts) anhand der Sortierreihenfolge des Attributnamens dargestellt (so wie in <a href=index.php?cmd=options_name_manager>Webshop-&gt;Attributnamen Manager</a> eingestellt). Wenn Sie nach <em>Attribut Sortierreihenfolge</em> sortieren, werden die Attributkombinationen des Artikels (oben nach unten) anhand der im Attributmanager eingestellten Sortierreihenfolge angezeigt (<a href=index.php?cmd=attributes_controller>Webshop-&gt;Attributmanager</a>).  Falls mehrere Attributnamen oder Attributwerte dieselbe Reihenfolge verwenden, erfolgt die Sortierung aufsteigend anhand des Namens." . "<br /><br />Sie können Ihre Artikel entweder nach Namen oder Artikelnummer sortieren, je nachdem, ob Sie die Checkbox &quot;Artikelnummer einschließen?&quot; angekreuzt haben oder nicht.<br /><br />');
