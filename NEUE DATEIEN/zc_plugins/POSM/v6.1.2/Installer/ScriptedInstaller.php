...
('POSM - Allgemein: Optionale Liste der Attributnamen', 'POSM_OPTIONAL_OPTION_NAMES_LIST', 'Geben Sie die Liste der optionalen Produktoptionen für Ihren Shop ein, indem Sie eine komma-getrennte Liste ihrer „option_id“-Werte verwenden. Alle Optionswerte, die mit den hier angegebenen Optionen verknüpft sind, werden bei der Feststellung, ob die Optionskombination eines Produkts verwaltet wird, ignoriert.<br><br>Verwenden Sie diesen Wert in Verbindung mit der „Liste der optionalen <em>Optionstypen</em>“, um die Konfigurationen der Optionskombinationen Ihres Shops zu verfeinern.',	43),
...
('POSM - Lagerbestandsanzeige: Hinweistexte bei nicht verwalteten Varianten anzeigen', 'POSM_SHOW_UNMANAGED_OPTIONS_STATUS', 'Sollten bei der Verarbeitung auf Shop-Seite Meldungen zum Lagerbestand (vorrätig/nicht vorrätig) für Produkte angezeigt werden, die nicht über <em>POSM</em> verwaltet werden? Bei der Einstellung <b>true</b> werden die Meldungen in Abhängigkeit von der Lagermenge des nicht verwalteten Produkts angezeigt – „Vorrätig“, wenn diese größer als 0 ist; andernfalls wird die Standardmeldung für nicht vorrätige Artikel (PRODUCTS_OPTIONS_STOCK_NOT_IN_STOCK) angezeigt.',	43),
...
('POSM - Abhängige Attribute: Bitte wählen Sie einfügen', 'POSM_DEPENDENT_ATTRS_PLEASE_CHOOSE', 'Legt fest, ob die Verarbeitung der abhängigen Attribute durch das Plugin eine Auswahlmöglichkeit vom Typ „Bitte wählen“ in die Dropdown-Optionen eines Produkts einfügen soll. Wenn <em>false</em> gilt, wird der Wert der ersten Option für jedes Attribut <em>als</em> Wert vom Typ „Bitte wählen Sie …“ angenommen.<br><br><b>Hinweis:</b> Diese Einstellung <b><i>gilt nicht</i></b>, wenn ein Artikel nur eine einzige Dropdown-Option hat.',	43),
...
('POSM - Alle anzeigen: Artikelnummer editierbar', 'POSM_VIEW_ALL_MODEL_UPDATE', 'Sollte die Verarbeitung unter „Alle anzeigen“ für <em>Katalog->Optionen verwalten\' Lagerbestand</em> die Aktualisierung der Modellnummern der verwalteten Varianten ermöglichen? Bei der Einstellung <b>false</b> werden die Modellnummern zwar angezeigt, können aber nicht aktualisiert werden; Sie müssen die Artikelnummern dann für jedes Produkt einzeln aktualisieren.',	43),
