...
* @version $Id: ScriptedInstaller.php 2026-06-29 11:09:29Z webchills $
*/
        ...
        $sql =
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . "
             ...
             VALUES
                ...
                ('General: Divider Color', 'POSM_DIVIDER_COLOR', '#006080', 'Enter the background color to be used for the divider in <em>Catalog :: Products\' Options\' Stock Manager.</em>', $cgi, 24, now(), NULL, NULL),
...
('POSM - Allgemein: Erinnerung für wieder lagernde Varianten', 'POSM_BIS_DATE_REMINDER', 'Wenn Ihr Shop die Labels von <em>POSM</em> mit Verfügbarkeitsdaten verwendet, möchten Sie möglicherweise eine Erinnerung erhalten, wenn ein Datum näher rückt. Legen Sie fest, wie viele Tage <b>vor</b> dem Ablaufdatum die Benachrichtigung versendet werden soll; setzen Sie den Wert auf 0 (Standard), wenn Sie keine Erinnerung wünschen.',	43),
('POSM - Allgemein: Attribut Typen, die verwaltet werden sollen', 'POSM_OPTIONS_TYPES_TO_MANAGE', 'Geben Sie die zu verwaltenden Optionstypen als komma-getrennte Liste ein. Derzeit werden nur die Optionstypen „Dropdown“ (0) und „Radiobutton“ (2) unterstützt!',	43),
('POSM - Allgemein: Optionale Liste der ignorierten Attributypen', 'POSM_OPTIONAL_OPTION_TYPES_LIST', 'Geben Sie die Optionstypen ein, die bei der Feststellung, ob die Optionskombination eines Artikels verwaltet wird, ignoriert werden sollen. Verwenden Sie dazu eine komma-getrennte Liste. <br><br>Die in Zen Cart integrierten Optionstypen sind Dropdown/Auswahl (0), Text (1), Optionsfeld (2), Kontrollkästchen (3), Datei (4) und Schreibgeschützt (5).',	43),
('POSM - Allgemein: Optionale Liste der Attributnamen', 'POSM_OPTIONAL_OPTION_NAMES_LIST', 'Geben Sie die Liste der optionalen Artikeloptionen für Ihren Shop ein, indem Sie eine komma-getrennte Liste ihrer „option_id“-Werte verwenden. Alle Optionswerte, die mit den hier angegebenen Optionen verknüpft sind, werden bei der Feststellung, ob die Optionskombination eines Artikels verwaltet wird, ignoriert.<br><br>Verwenden Sie diesen Wert in Verbindung mit der „Liste der optionalen <em>Optionstypen</em>“, um die Konfigurationen der Optionskombinationen Ihres Shops zu verfeinern.',	43),
('POSM - Lagerbestandsanzeige: Hinweistexte anzeigen', 'POSM_SHOW_STOCK_MESSAGES', 'Wählen Sie aus, wo (Nur im Shop / Store Only , Nur in der Administration / Admin Only, Beides / Both oder Keines von beiden / Neither) die <em>POSM</em>-Meldungen zu verfügbaren bzw. nicht verfügbaren Artikeln angezeigt werden sollen.<br><br>Wenn Sie <b>Nur im Shop (Store Only)</b> oder <b>Beides (Both)</b> wählen, wird dieser Status Ihren Kunden auf den Seiten „Warenkorb“, „Checkout Confirmation“ und „Bestellverlauf“ angezeigt. Beachten Sie auch die Einstellung <em>Abhängige Attribute: Anzeige des Lagerbestands</em> weiter unten, die unabhängig von dieser Einstellung funktioniert.<br><br>Wenn Sie <b>Nur in der Administration (Admin Only)</b> oder <b>Beides (Both)</b> wählen, werden die Meldungen zu verfügbaren und nicht verfügbaren Artikeln in der Detailansicht unter <em>Kunden&gt;&gt;Bestellungen</em>, auf Rechnungen und Lieferscheinen angezeigt.',	43),
('POSM - Lagerbestandsanzeige: Hinweistexte bei nicht verwalteten Varianten anzeigen', 'POSM_SHOW_UNMANAGED_OPTIONS_STATUS', 'Sollten bei der Verarbeitung im Frontend Meldungen zum Lagerbestand (vorrätig/nicht vorrätig) für Artikel angezeigt werden, die nicht über <em>POSM</em> verwaltet werden? Bei der Einstellung <b>true</b> werden die Meldungen in Abhängigkeit von der Lagermenge des nicht verwalteten Artikels angezeigt – „Vorrätig“, wenn diese größer als 0 ist; andernfalls wird die Standardmeldung für nicht vorrätige Artikel (PRODUCTS_OPTIONS_STOCK_NOT_IN_STOCK) angezeigt.',	43),
('POSM - Lagerbestandsanzeige: Auf Lager Status anzeigen', 'POSM_SHOW_IN_STOCK_MESSAGE', 'Legen Sie fest, ob der Artikelstatus „auf Lager“ angezeigt werden soll, <em>überall dort</em>, wo diese Statusanzeige aktiviert ist. Bei der Einstellung <b>false</b> werden nur Meldungen zu nicht vorrätigen Artikeln angezeigt.',	43),
('POSM - Administration: Artikelnummerfeld Länge', 'POSM_ADMIN_MODEL_WIDTH', 'Verwenden Sie diese Einstellung, um die Breite des Feldes <em>Artikelnummer/SKU</em> zu steuern, das auf den Seiten <em>POSM Attribut Lagerbestands Manager &mdash; Lagerbestände verwalten</em> und <em>POSM Attribut Lagerbestands Manager &mdash; Alle anzeigen</em> angezeigt wird. Geben Sie einen gültigen CSS-Wert für „width“ ein, z. B. 9em (Standard) oder 9px.<br><br><b>Hinweis:</b> Lassen Sie das Feld leer, um die in der Datenbank definierte Feldbreite zu verwenden.<br>',	43),
('POSM - Abhängige Attribute aktivieren', 'POSM_DEPENDENT_ATTRS_ENABLE', 'Wollen Sie voneinander abhängige Attribute aktivieren?',	43),
('POSM - Abhängige Attribute: Bitte wählen Sie einfügen', 'POSM_DEPENDENT_ATTRS_PLEASE_CHOOSE', 'Legt fest, ob die Verarbeitung der abhängigen Attribute durch das Plugin eine Auswahlmöglichkeit vom Typ „Bitte wählen“ in die Dropdown-Optionen eines Artikels einfügen soll. Wenn <em>false</em> gilt, wird der Wert der ersten Option für jedes Attribut <em>als</em> Wert vom Typ „Bitte wählen Sie …“ angenommen.<br><br><b>Hinweis:</b> Diese Einstellung <b><i>gilt nicht</i></b>, wenn ein Artikel nur eine einzige Dropdown-Option hat.',	43),
('POSM - Abhängige Attribute: Artikelnummer anzeigen', 'POSM_DEPENDENT_ATTRS_SHOW_MODEL', 'Legen Sie fest, ob bei der Verarbeitung der abhängigen Attribute durch das Plugin die Artikelnummern für jeden Attributwert in die endgültige, auswählbare Attributoption aufgenommen werden sollen.<br><br><strong>Hinweis:</strong> Eine Artikelnummer wird <b>nur dann</b> aufgenommen, wenn dieser Wert keine leere Zeichenkette ist.',	43),
('POSM - Abhängige Attribute: Lagerbestand anzeigen', 'POSM_DEPENDENT_ATTRS_STOCK_STATUS', 'Legen Sie fest, ob bei der Verarbeitung der abhängigen Attribute durch das Plugin der Status „auf Lager“ bzw. „nicht auf Lager“ für jeden Attributwert in der Option des letzten, auswählbaren Attributs berücksichtigt werden soll.<br><br><strong>Hinweis:</strong> Der Status „auf Lager“ wird <em>nur</em> berücksichtigt, <em>wenn <em>„Anzeige des Lagerbestands: Status ‚auf Lager‘ einbeziehen?“</em> auf <b>„true“</b> gesetzt ist.',	43),
('POSM - Abhängige Attribute: Lagerbestand bei lagernder Kombination anzeigen', 'POSM_DEPENDENT_ATTRS_STOCK_STATUS_QTY', 'Wenn sowohl <em>Abhängige Attribute: Anzeige des Lagerbestands</em> als auch <em>Anzeige des Lagerbestands: „Auf Lager“-Status einbeziehen?</em> auf <b>true</b> gesetzt sind, soll dann die verfügbare Menge angezeigt werden, wenn die Optionskombination <em>Auf Lager</em> lautet?',	43),
('POSM - Abhängige Attribute: CSS Klasse für außen', 'POSM_ATTRIBUTE_WRAPPER_SELECTOR', 'Geben Sie den CSS-Selektor <em>outer</em> an (Standard: eine leere Zeichenkette), der <b>alle</b> Elemente umschließt, die einer einzelnen Option zugeordnet sind.<br><br><b>Hinweise: </b><ol><li>Für die in Zen Cart integrierten Templates <code>responsive_classic</code> und <code>template_default</code> (sowie deren Klone) sollte dieser Wert auf <em>.attribBlock</em>.</li><li>Für das Template <code>Bootstrap</code> (sowie deren Klone) sollte dieser Wert auf eine leere Zeichenkette gesetzt werden. </li></ul>',	43),
('POSM - Abhängige Attribute: CSS Klasse für innen', 'POSM_ATTRIBUTE_SELECTOR', 'Geben Sie den CSS-Selektor <em>inner</em> an (Standard: <em>.wrapperAttribsOptions</em>), der mindestens den Namen jeder Option enthält. <b>Hinweis:</b> Dieser Wert sollte <em>nur</em> geändert werden, wenn Ihr Template die Darstellungsformatierung der Attribute geändert hat.',	43),
('POSM - Abhängige Attribute: CSS Klasse für Attributname', 'POSM_OPTION_NAME_SELECTOR', 'Geben Sie den CSS-Selektor an (Standard: <em>.optionName</em>), der das Element identifiziert, das den Namen der aktuellen Option enthält. <b>Hinweis:</b> Dieser Wert sollte nur geändert werden, wenn in Ihrem Template die Darstellungsformatierung der Attribute geändert wurde.',	43),
('POSM - Abhängige Attribute: CSS Klasse für Attributbilder', 'POSM_ATTRIBUTE_IMAGE_SELECTOR', 'Geben Sie den CSS-Selektor an (Standard: <em>.attribImg</em>), der – sofern konfiguriert – das Bild jedes Attributs umschließt. <b>Hinweis:</b> Dieser Wert sollte nur geändert werden, wenn Ihre Template die Darstellungsformatierung der Attribute geändert hat.',	43),
('POSM - Abhängige Attribute: Minified Script verwenden', 'POSM_USE_MINIFIED_JSCRIPT', 'Soll bei der Verarbeitung der abhängigen Attribute die minimierte Version des jQuery-Skripts geladen werden, um die Ladezeit der Artikelseite zu verkürzen?',	43),
('POSM - Alle anzeigen: Artikelnummer editierbar', 'POSM_VIEW_ALL_MODEL_UPDATE', 'Soll die Seite <em>POSM Attribute Lagerbestands Manager &mdash; Alle anzeigen</em> die Aktualisierung der Artikelnummern der verwalteten Varianten ermöglichen? Bei der Einstellung <b>false</b> werden die Artikelnummern zwar angezeigt, können aber nicht editiert/aktualisiert werden. Sie müssen die Artikelnummern dann für jeden Artikel einzeln aktualisieren.',	43),
('POSM - Alle anzeigen: Artikel pro Seite', 'POSM_MAX_PRODUCTS_VIEW_ALL', 'Geben Sie die maximale Anzahl der Artikel ein, die auf einer einzelnen Seite des Tools <em>POSM Attribute Lagerbestands Manager &mdash; Alle anzeigen</em> angezeigt werden sollen.',	43),
('POSM - Artikelnummern im Warenkorb anzeigen', 'POSM_CART_DISPLAY_MODEL_NUMBERS', 'Soll auf der Seite <code>Warenkorb</code> die Artikelnummer eines Artikels angezeigt werden? Wenn Sie <code>true</code> wählen, wird die Artikelnummer eines Artikels zur Anzeige an dessen Namen angehängt, z. B. „Artikelname [Artikelnummer]“, sofern die Artikelnummer nicht leer ist.',	43),
('POSM - Debugmodus', 'POSM_ENABLE_DEBUG', 'Wenn diese Option aktiviert ist, schreibt <em>POSM</em> Debug-Informationen entweder in die Datei „myDEBUG-POSM-*.log“ (für Aktionen auf der Shop-Seite) oder in die Datei „myDEBUG-POSM-adm-*.log“ (für Aktionen auf der Admin-Seite) ins Verzeichnis „\logs“ Ihres Shops.<br>Nur zur Fehleranalyse aktivieren!', 43)";
