...
('POSM - Lagerbestandsanzeige: Hinweistexte bei nicht verwalteten Varianten anzeigen', 'POSM_SHOW_STOCK_MESSAGES', 'Wählen Sie aus, wo (Nur im Shop, Nur für Administratoren, Beides oder Keines von beiden) die <em>POSM</em>-Meldungen zu verfügbaren bzw. nicht verfügbaren Artikeln angezeigt werden sollen.<br><br>Wenn Sie <b>Nur im Shop</b> oder <b>Beides</b> wählen, wird dieser Status Ihren Kunden auf den Seiten „Warenkorb“, „Checkout Confirmation“ und „Bestellverlauf“ angezeigt. Beachten Sie auch die Einstellung <em>Abhängige Attribute: Anzeige des Lagerbestands</em> weiter unten, die unabhängig von dieser Einstellung funktioniert.<br><br>Wenn Sie <b>Nur für Administratoren</b> oder <b>Beides</b> wählen, werden die Meldungen zu verfügbaren und nicht verfügbaren Artikeln in der Detailansicht unter <em>Kunden&gt;&gt;Bestellungen</em>, auf Rechnungen und Lieferscheinen angezeigt.',	43),
...
('POSM - Administration: Artikelnummerfeld Länge', 'POSM_ADMIN_MODEL_WIDTH', 'Verwenden Sie diese Einstellung, um die Breite des Feldes <em>Optionsmodell/SKU</em> zu steuern, das auf den Seiten <em>Katalog :: Optionen verwalten – Lagerbestand</em> und <em>Katalog :: Optionen – Lagerbestand – Alle anzeigen</em> angezeigt wird. Geben Sie einen gültigen CSS-Wert für „width“ ein, z. B. 9em (Standard) oder 9px.<br><br><b>Hinweis:</b> Lassen Sie das Feld leer, um die in der Datenbank definierte Feldbreite zu verwenden.<br>',	43),
...
('POSM - Alle anzeigen: Artikelnummer editierbar', 'POSM_VIEW_ALL_MODEL_UPDATE', 'Sollte die Verarbeitung unter „Alle anzeigen“ für <em>Katalog->Optionen verwalten\' Lagerbestand</em> die Aktualisierung der Artikelnummern der verwalteten Varianten ermöglichen? Bei der Einstellung <b>false</b> werden die Artikelnummern zwar angezeigt, können aber nicht aktualisiert werden; Sie müssen die Artikelnummern dann für jeden Artikel einzeln aktualisieren.',	43),
('POSM - Alle anzeigen: Artikel pro Seite', 'POSM_MAX_PRODUCTS_VIEW_ALL', 'Geben Sie die maximale Anzahl der Artikel ein, die auf einer einzelnen Seite des Tools <em>Alle anzeigen</em> angezeigt werden sollen.',	43),
...
('POSM - Debugmodus', 'POSM_ENABLE_DEBUG', 'Wenn diese Option aktiviert ist, schreibt <em>POSM</em> Debug-Informationen entweder in die Datei „myDEBUG-POSM-*.log“ (für Aktionen auf der Shop-Seite) oder in die Datei „myDEBUG-POSM-adm-*.log“ (für Aktionen auf der Admin-Seite) ins Verzeichnis „\logs“ Ihres Shops.', 43)";
